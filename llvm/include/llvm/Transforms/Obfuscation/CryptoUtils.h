...
#define S1(x, n) RORc((x), (n))
#define R1(x, n) (((x)&0xFFFFFFFFUL) >> (n))
#define Sigma0(x) (S1(x, 2) ^ S1(x, 13) ^ S1(x, 22))
#define Sigma1(x) (S1(x, 6) ^ S1(x, 11) ^ S1(x, 25))
#define Gamma0(x) (S1(x, 7) ^ S1(x, 18) ^ R1(x, 3))
#define Gamma1(x) (S1(x, 17) ^ S1(x, 19) ^ R1(x, 10))
