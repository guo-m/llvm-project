...
bool Flattening::flatten(Function *f) {
...
#else
  errs() << f->getName() << "[Frontend]: (Warning)  Not  call createLowerSwitchPass.\n";
#endif
  ...
  // Nothing to flatten
  if (origBB.size() <= 1) {
    errs() << f->getName() << "[Frontend]: (Warning) Function too small. Not Flattening.\n";
    return false;
  }
  ...
  errs() << "[Frontend]: Remove branch jump from 1st BB.\n";
  ...
  errs() << "[Frontend]: Put all BB in the switch end\n";
