...
namespace llvm {
        ...
        class StringObfuscationPass: public llvm::ModulePass {
               ...
               void addDecodeFunction(Module *mod, std::vector<encVar*> *gvars) {
                        ...
                        auto callee = mod->getOrInsertFunction(".datadiv_decode" + random_str, FuncTy);
                        Function* fdecode = dyn_cast<Function>(callee.getCallee());  
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                loadElement->setAlignment(llvm::Align(1));
#else
